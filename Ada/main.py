...
# n_labels = 800
# train_iter = 100
# train_root = 'FER/datasets/RAFdataset/train1/'
# test_root = 'FER/datasets/RAFdataset/test1/'
# train_label_root = 'FER/datasets/RAFdataset/RAF_train_label1.txt'
# test_label_root = 'FER/datasets/RAFdataset/RAF_test_label1.txt'

epochs = 20
num_workers = 4
n_labels = 200
train_iter = 100
train_root = '../data/PCTest/RAFdataset/train1/'
test_root = '../data/PCTest/RAFdataset/test1/'
train_label_root = '../data/PCTest/RAFdataset/RAF_train_label1.txt'
test_label_root = '../data/PCTest/RAFdataset/RAF_test_label1.txt'
...
def main():
    ...
    console_logger = ConsoleLogger(os.path.join(args.out, 'console_log.txt'),title='console_log',console_content='')
